...
<title>REDC Alumni History</title>
  ...
  <div  class="content">
	...
	<ul>
	 <li>
	  ...
	  {/foreach}
      <li>
	  		<a class="selected">Attended programmes</a>
	  </li>
	  <li>
...
<div class="clear"></div>
      ...
      </div><!--<div class="add"><a href="#" ><img src="{$GENERAL.FRONT_IMG_URL}/requestafacility.gif" alt="Programme Finder"  border="0"/></a></div><div class="add1"><a href="#" ><img src="images/virtualtour.gif" alt="Programme Finder"  border="0"/></a></div>-->
    </div>
    <div class="right_pane_lvl1">
    
      <div class="main_heading_cms" style="background:url({$GENERAL.FRONT_UPLOAD_URL}/homeSectionPictures/{$simage.0.sec_image}) no-repeat;"><h1>REDC Alumni History</h1></div>
        <!--  <div class="main_heading">REDC Alumni History</div>-->
          <div class="contents_body_cms">
		  	
		  		{foreach from=$data item ='history'}
					
						<span style="color:#F79E4D;"><strong>Programme Name:</strong></span> {$history.name}
						<br />
						<span style="color:#F79E4D;"><strong>Attended Date:</strong></span> {$history.startdate|date_format} To {$history.enddate|date_format}
						<br />
						<span style="color:#F79E4D;"><strong>Programme Instructor:</strong></span> {$history.instructor}
						<hr color="#CCCCCC" size="1" style="padding-bottom:5px;" />
