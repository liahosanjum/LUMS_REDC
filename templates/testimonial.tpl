...
<title>REDC Alumni Testimonials</title>
...
{*			<a href="{$GENERAL.BASE_URL_ROOT}/alumni_login.php" class="alumnilogin">REDC Alumni Login</a>*}
			<a href="#" class="alumnilogin">REDC Alumni Login</a>
	  </li>
	{php} } {/php}    	
		<li>
	  		<!--<a class="alumnilogin" href="javascript:void(0)">Alumni Login</a>-->
			<a class="selected">REDC Alumni Testimonials</a>
	  </li>
 		{php}	
    ...
    <div class="right_pane_lvl1">
          <div class="main_heading_cms" style="background:url({$GENERAL.FRONT_UPLOAD_URL}/homeSectionPictures/{$simage.0.sec_image}) no-repeat;"><h1>REDC Alumni Testimonials</h1></div>
