    ...
    <div class="center_pane">
	  ...
	  <div class="clear"></div>
	 	  <div class="basic" style="float:left;"  id="list1a">
			...
			<a style="display:{if $pdata.fa_facname eq "" and $pdata.facultyinfo eq ""}none;{/if}">Programme Director(s)</a>
			...
			<a style="display:{if $pdata.fa_facname eq "" and $pdata.facultyinfo eq ""}none;{/if}">Additional Faculty</a>
