...
<div class="contentspane">
  <div  class="content">
	...
	<ul>
		...
		{ {/php}
	  <li>
	  		<!--<a class="alumnilogin" href="javascript:void(0)">REDC Alumni Login</a>-->
...
{*	  <li>
    ...
    <div class="right_pane_lvl1">
          <div class="main_heading_cms" style="background:url({$GENERAL.FRONT_UPLOAD_URL}/homeSectionPictures/{$simage.0.sec_image}) no-repeat;"><h1>REDC Alumni</h1></div>
