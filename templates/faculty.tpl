...
<div class="contentspane">
  <div  class="content">
    <div class="left_pane">
	  ...
	  {/foreach}
	  	<li><a href="{$GENERAL.BASE_URL_ROOT}/faculty_profiles.php?section_id=4">Faculty Directory</a></li>
	  </ul>
       <div id="conferenceservicesrequestForm"><a href="#" class="conferenceservice"><img style="padding-top:20px;" src="{$GENERAL.FRONT_IMG_URL}/requestafacility.gif" alt="Programme Finder"  border="0"/></a></div><div class="add1"><a href="#" ><img src="images/virtualtour.gif" alt="Programme Finder"  border="0"/></a></div>
