...
<div class="contentspane">
  <div  class="content">
	...
	<div class="left_pane">
	  ...
	  <ul>
      <li><a href="{$GENERAL.BASE_URL_ROOT}/site_map.php?pagename=Site Map&pcid=&url=quick_links#" class="{if $smarty.get.pagename eq $pagedata.pagename}selected{/if}">Site Index</a></li>
      <li><a href="{$GENERAL.BASE_URL_ROOT}/faq.php?pagename=FAQs&section_id=0" class="level2">FAQs</a></li>
      <li><a href="{$GENERAL.BASE_URL_ROOT}/news.php?pagename=News and Events" class="level2">News/Events</a></li>
	 </ul>
       <div ><a href="{$GENERAL.BASE_URL_ROOT}/virtualtour.php" ><img style="padding-top:20px;" src="images/virtualtour.gif" alt="Programme Finder"  border="0"/></a></div>
		<div class="clear"></div>
