...
-->				<option value='Ms.'>Ms.</option>
		...
		<div style="clear:both;">
          <div class="input_txt_apply">What are your objectives of attending this programme? What do you expect to achieve by the end of this programme:<span class="required">&nbsp;*</span></div>
          <div class="input_area_txt">
            <textarea id='pro_objectives' class='bluebar_txtarea' name='objectives' tabindex='' maxlength='300' onkeyup='return ismaxlength(this)'>{$data.objectives}</textarea>
          </div>
