...
<div class="contentspane">
  <div  class="content">
    <div class="left_pane">
      ...
      <li><a class="{if $smarty.get.pcid eq $entry.pcid}selected{/if}" href="{$GENERAL.BASE_URL_ROOT}/conference_services.php?section_id={$entry.psid}&pcid={$entry.pcid}">{$entry.pagename}</a></li>
	  <!--<div class="left_links"><a href="#" class="level2" >Conference</a></div>-->
	  {/foreach}
	  </ul>
       <div id="conferenceservicesrequestForm">
	  <!-- <ul>
	   		<li><a href="#" class="conferenceservice">Request for booking a Facility</a></li>
			<li><a href="{$GENERAL.BASE_URL_ROOT}/virtualtour.php" >Virtual Tour</a></li>
	   </ul>-->
	   <a href="#" class="conferenceservice"><img style="padding-top:20px;" src="{$GENERAL.FRONT_IMG_URL}/requestafacility.gif" alt="Request a facility"  border="0"/></a></div><div class="add1"><a href="{$GENERAL.BASE_URL_ROOT}/virtualtour.php" ><img src="images/virtualtour.gif" alt="Virtual Tour"  border="0"/></a></div>
