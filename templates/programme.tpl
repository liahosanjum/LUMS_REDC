...
<script language="javascript">
	...
	var oepid 	 = '';
	var callbackurl = '{php}echo SITE_URL;{/php}/programme.php?section_id=0&pcid='+{$smarty.get.pcid};
...
<!--				</div>-->
       ...
       <div  ><a href="{php}echo SITE_URL;{/php}/prog_finder.php?section_id=0" ><img style="padding-top:20px;" src="images/program_finder.gif" alt="Programme Finder"  border="0"/></a></div>
