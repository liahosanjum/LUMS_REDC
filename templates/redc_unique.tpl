...
<div class="contentspane">
  <div  class="content">
    <div class="left_pane">
      ...
      <li><a class="{if $smarty.get.pcid eq $entry.pcid}selected{/if}" href="{$GENERAL.BASE_URL_ROOT}/redc_unique.php?section_id={$entry.psid}&pcid={$entry.pcid}">{$entry.pagename}</a></li>
	  <!--<div class="left_links"><a href="#" class="level2" >Conference</a></div>-->
	  {/foreach}
	  </ul>
       <div id="conferenceservicesrequestForm"><a href="#" class="conferenceservice"><img style="padding-top:20px;" src="{$GENERAL.FRONT_IMG_URL}/requestafacility.gif" alt="Programme Finder"  border="0"/></a></div>
	   <div class="add1"><a href="{php}echo SITE_URL;{/php}/virtualtour.php" ><img src="images/virtualtour.gif" alt="Programme Finder"  border="0"/></a></div>
