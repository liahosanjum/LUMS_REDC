...
<link type='text/css' href='{$GENERAL.BASE_URL_ROOT}/css/alumni.css' rel='stylesheet' media='screen' />
<link type='text/css' href='{$GENERAL.BASE_URL_ROOT}/css/form.css' rel='stylesheet' media='screen' />
<link rel="stylesheet"type="text/css" href="{$GENERAL.BASE_URL_ROOT}/css/accordion.css" />
<link href="{$GENERAL.BASE_URL_ROOT}/css/style.css" rel="stylesheet" type="text/css" />
<link href="{$GENERAL.BASE_URL_ROOT}/css/apply.css" rel="stylesheet" type="text/css" />
