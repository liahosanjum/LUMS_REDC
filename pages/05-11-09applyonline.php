...
// GLOBAL VARIABLE TO RETIAN THE USER RECORD IF ALREADY REGISTERED
	...
	$personal = '';
	$personalLink = 'javascript:void(0)';
	$contact = '';
	$contactLink = 'javascript:void(0)';
	$organizational = '';
	$organizationalLink = 'javascript:void(0)';
	$professional = '';
	$professionalLink = 'javascript:void(0)';
	$sponsor = '';
	$sponsorLink = 'javascript:void(0)';
	$information = '';
	$informationLink = 'javascript:void(0)';
...
if (empty($action)) {
	...
	<a href='#' title='Close' class='modalCloseX simplemodal-close'><img src='images/applyonline/crossicon.jpg' border='0' /></a>
		...
		<div class='applysteps'>
        	<ul>
                ...
                <li>
                	<p class='".$contact."' id='p3'><a href='".$contactLink."'>Contact Data</a></p><img src='images/applyonline/3_trans.gif' id='i3' />
                </li>
                <li>
                	<p class='".$organizational."' id='p4'><a href='".$organizationalLink."'>Organisational Data</a></p><img src='images/applyonline/4_trans.gif' id='i4' />
                </li>
                <li>
                	<p class='".$professional."' id='p5'><a href='".$professionalLink."'>Professional Data</a></p><img src='images/applyonline/5_trans.gif' id='i5' />
                </li>
                <li>
                	<p class='".$sponsor."' id='p6'><a href='".$sponsorLink."'>Sponsorship and Invoicing</a></p><img src='images/applyonline/6_trans.gif' id='i6' />
                </li>
                <li>
	...
	<div id='programmename'><span id='spnProgrammeName'>".$_REQUEST['pname']."</span></div>
	<form action='#' style='display:none;'>
	
	<div class='forminputs-apply'>
	
	<div id='s2' class='apply-content1'>
	<h2 class='apply-title1'>Personal Data:</h2>
	<div class='apply-message' style='display:none;'></div>
		...
		<div class='apply-content2'>
			...
			<ul>	
				...
				<li>
					<select name='oepprogrammes' class='bluebar' id='apply-oepprogrammes' tabindex='1001'>
	...
	<div class='apply-content1' id='s3' style='display:none;'>
		<h2 class='apply-title1'>Contact Data:</h2>
		<div class='apply-message' style='display:none;'></div>
		<div class='clear' />
		<br/>
		<div class='apply-content2'>		
	...
	<h2 class='apply-title1'>Organisational Data:</h2>
	<div class='apply-message' style='display:none;'></div>
		<div class='clear'></div>
	...
	<h2 class='apply-title1'>Professional Data:</h2>
	<div class='apply-message' style='display:none;'></div>
	<div class='clear' />
		<div class='apply-content2'>
	...
	<h2 class='apply-title1'>Sponsorship and Invoicing:</h2>
	<div class='apply-message' style='display:none;'></div>
		<div class='apply-content2'>
	...
	<div class='apply-content1' id='s7' style='display:none;'>
		<h2 class='apply-title1'>Information Source:</h2>
		<div class='apply-message' style='display:none;'></div>
		<div class='clear'></div>
		<br/>
		<ul>
