              ...
              <td width="617" valign="top" class="boderInner2"><table width="98%" border="0" cellspacing="1" cellpadding="1" class="normalTxt">
				...
				<tr>
                  ...
                  <tr class="row2">
                    ...
                    <td width="81%" align="left"><input type="text" name="firstname" class="input" value="{$data.firstname|escape}"  maxlength="30"/>
                      <span class="required">&nbsp;*</span></td>
                  </tr> 
                  <tr class="row2">
                  ...
                  <tr class="row2">
                    ...
                    <td width="81%" align="left"><input type="text" name="lastname" class="input" value="{$data.lastname|escape}"  maxlength="30"/>
					    <span class="required">&nbsp;*</span></td>
                  </tr> 
				  <tr class="row2">
				  ...
				  <tr class="row2">
                    ...
                    <td width="81%" align="left"><input type="text" name="email" class="input" value="{$data.email|escape}"  maxlength="50"/>
                      <span class="required">&nbsp;*</span></td>
                  </tr>
				  <tr>
            ...
            <tr>
              ...
              <td width="439" align="right" valign="top"><div class="toolbar" id="toolbar">
                  <table class="toolbar">
					...
					<td class="button" id="toolbar-apply" ><a style="toolbar"href='{$GENERAL.BASE_URL_ADMIN}/alumnimanagement.php?action=export&search_by_name={$formvars.search_by_name}&search_by_companyname={$formvars.search_by_companyname}'><img  border="0" type="image" src="{$GENERAL.ADMIN_IMG_URL}/toolbar/icon-32-export.png" /><br/> Export To CSV </a> </td>
					<!--{/if}-->
      ...
      <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
         ...
         <table width="100%" border="0"  class="grid" style="padding-top:7px;">
                      <tr  height="20">
                        <td style="width:30%" align="center" ><a href="javascript:sortRecords('firstname',true)" class="th" >Name</a></td>
                        <td style="width:15%" align="center" ><a href="javascript:sortRecords('email',true)"  class="th">Email</a></td>
						<td style="width:15%" align="center" ><a href="javascript:sortRecords('companyname',true)"  class="th">Organization</a></td>
						<td style="width:30%" align="center" ><a href="javascript:sortRecords('designation',true)"  class="th">Designation</a></td>
						<td style="width:15%" align="center" ><a href="javascript:sortRecords('numprogrammes',true)" class="th">No of Programmes</a></td>
						<td style="width:15%" align="center" ><a href="javascript:sortRecords('isactive',true)"  class="th">Enabled</a></td>
						<td style="width:15%" align="center" ><a href="javascript:sortRecords('registrationdate',true)"  class="th">Dated</a></td>
