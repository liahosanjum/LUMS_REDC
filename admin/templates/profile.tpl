...
<table width="991" border="0" align="center" cellpadding="0" cellspacing="0">
 <tr>
  ...
  <tr>
	...
	<!--- content area form --->
	 <form action="{$GENERAL.BASE_URL_ADMIN}/profile.php?action=submit&mode={$pageview}" method="post" enctype="multipart/form-data">
        ...
        <td class="boderInner1">
		  <table width="960" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td width="445"><span class="pageTitle"><span class="tableHeader">Profile</span> Manager </span><span class="pageTitle1">[{if $pageview eq 'add'}Add{else}Edit{/if} Profile]</span></td>
                <td width="439" align="right" valign="top">
				<div class="toolbar" id="toolbar">
                    <table class="toolbar">
                      <tbody>
                        <tr>
                         <td class="button" id="toolbar-apply"><a href="{$GENERAL.BASE_URL_ADMIN}/changepassword.php" class="toolbar"> <img  value="" src="{$GENERAL.ADMIN_IMG_URL}/toolbar/icon-32-config.png" style="border:0px;"  /> <br />
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1" class="normalTxt">
					  ...
					  <tr><td height="5"></td></tr>
					   <tr>
					     ...
					     <td width="75%" align="left"><input class="input" name="first_name" type="text" id="first_name" value="{$data.first_name|escape}" size="30" maxlength="30" />
				         <span class="required">*</span></td>
				      </tr>					  
					 ...
					 <tr><td height="5"></td></tr>
					  <tr>
					     ...
					     <td width="75%" align="left"><input class="input" name="last_name" type="text" id="last_name" value="{$data.last_name|escape}" size="30" maxlength="30" />
				         <span class="required">*</span></td>
				      </tr>	
					  <tr><td height="5"></td></tr>
					  <tr>
					     <td width="25%" align="right">Email:&nbsp; </td>
					     <td width="75%" align="left"><input class="input" name="email" type="text" id="email" value="{$data.email|escape}" size="50" maxlength="50" />
				         </td>
				      </tr>	
					   <tr><td height="5"></td></tr>
					  <tr>
					     <td width="25%" align="right">Username:&nbsp; </td>
					     <td width="75%" align="left"><input class="input" name="username" type="text" id="username" value="{$data.username|escape}" size="30" maxlength="30" readonly="true" /><span class="required">&nbsp;*</span>
				        </td>
				      </tr>						  
					   <tr><td height="5"></td></tr>
					   {*
					  <tr>
					     ...
					     <td width="75%" align="left"><input class="input" name="password" type="password" id="password" value="{$data.password|escape}" size="30" maxlength="30" /><span class="required">&nbsp;*</span></td>
				      </tr>					  
					  <tr><td height="5"></td></tr>       
					  *}
					 <tr height="25" >
