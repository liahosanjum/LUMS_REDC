...
<script type="text/javascript">
	...
	function deleteconfirmation(category_id)
	{
		...
		{
			window.location.href='faqcategorymanagement.php?action=del&category_id='	+ category_id;
		}	
	}
...
<table width="991" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <!--- content area form --->
  <form action="{$GENERAL.BASE_URL_ADMIN}/faqcategorymanagement.php?action=submit&mode={$pageview}" method="post"  enctype="multipart/form-data">
      ...
      <tr>
        <td class="boderInner1"><table width="960" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td width="445"><span class="pageTitle"><span class="tableHeader">FAQs Categories Manager </span></td>
                  ...
                  <table class="toolbar">
                    <tbody>
                      <tr>
                        ...
                        <td class="button" id="toolbar-cancel"><a href="javascript:location.href='{$GENERAL.BASE_URL_ADMIN}/faqcategorymanagement.php'" class="toolbar"><img src="{$GENERAL.ADMIN_IMG_URL}/toolbar/restore_f2.png" border="0" alt="" /> <br />Back</a></td>
                      </tr>
                    </tbody>
                  </table>
                </div></td>
        ...
        <td class="boderInner2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td width="617" valign="top" class="boderInner2"><table width="98%" border="0" cellspacing="1" cellpadding="1" class="normalTxt">
                  <tr height="25" >
                    <td align="left" colspan="2" class="tipbox"><input type="hidden" name="category_id" value="{$data.category_id}" />                    </td>
                  </tr>
                  <tr class="row2">
                    <td width="19%" align="right">Category Name :&nbsp;</td>
                    <td width="81%" align="left"><input type="text" name="category_name" class="input" maxlength="50" value="{$data.category_name}" />
                          ...
                          <div style="overflow: hidden; display: block; visibility: visible;  height: 1%;" class="normalTxt">
                            <div style="padding: 5px;" id="help1">
                              <ul>
                                ...
                                <li>To go back to Existing FAQs categories, click Cancel button</li>
  ...
  <!--- content area  --->
  {else}
  <form action="{$GENERAL.BASE_URL_ADMIN}/faqcategorymanagement.php" method="post">
    <table width="962" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td class="boderInner1"><table width="960" border="0" cellspacing="0" cellpadding="0">
            <tr>
            ...
            <tr>
              <td width="10" height="48" align="center">&nbsp;</td>
              <td width="56"><img src="{$GENERAL.ADMIN_IMG_URL}/faq2.png" alt="" width="48" height="48" /></td>
              <td width="445"><span class="pageTitle">FAQs Categories Manager </span></td>
              <td width="439" align="right" valign="top"><div class="toolbar" id="toolbar">
                  <table class="toolbar">
                    <tr>
                      <td class="button" id="toolbar-apply" ><a href='{$GENERAL.BASE_URL_ADMIN}/faqcategorymanagement.php?action=add'><img  border="0" type="image" src="{$GENERAL.ADMIN_IMG_URL}/toolbar/icon-32-new.png" /><br/> Add </a> </td>
                    </tr>
                  </table>
                </div></td>
              <td width="10" valign="top">&nbsp;</td>
      ...
      <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
         ...
         <table width="100%" border="0"  class="grid">
                      <tr  height="20">
                        <td style="width:40%" align="center" ><a href="javascript:sortRecords('name',true)" class="th" >Category Name</a></td>
                        <td align="center" class="th">View Question</td>
						<!--<td align="center" class="th"> Enabled</td>-->
                      ...
                      <tr class="row2"  style="height:25px;" >
                        ...
                        <td align="center"><a href="{$GENERAL.BASE_URL_ADMIN}/faqmanagement.php?category_id={$entry.fcatid}" class="link_emp">View Questions</a></td>
						
                        <td align="center"><img  style="border:0; cursor:pointer" border="0" type="image" src="{$GENERAL.ADMIN_IMG_URL}/toolbar/edit_s.png"  onclick="javascript:location.href='{$GENERAL.BASE_URL_ADMIN}/faqcategorymanagement.php?action=edit&category_id={$entry.fcatid|escape}'"  class="btnText"  /> </td>
                        <td align="center"><img  style="border:0; cursor:pointer" type="image" src="{$GENERAL.ADMIN_IMG_URL}/toolbar/delete_s.png"  onclick="javascript:deleteconfirmation('{$entry.fcatid|escape}');"  class="btnText"  /> </td>
                      </tr>
                      {/foreach}
                      <tr>
                        ...
                        <div style="overflow: hidden; display: block; visibility: visible;  height: 1%;" class="normalTxt">
                          <div style="padding: 5px;" id="help5">
                            <ul>
							  ...
							  <li>To view FAQs againgst each category, click the 'View Questions' link</li>
