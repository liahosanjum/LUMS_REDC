...
<script type="text/javascript">
	...
	function deleteconfirmation(ofpbid)
	{
		if(confirm("Do you really want to delete?"))
		{
			window.location.href='ofpbrouchermanagement.php?action=del&ofpbid='	+ ofpbid;
		}	
	}
...
<table width="991" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <!--- content area form --->
  <form action="{$GENERAL.BASE_URL_ADMIN}/ofpbrouchermanagement.php?action=submit&mode={$pageview}{if $pageview eq 'edit'}&ofpbid={$data.ofpbid}{/if}" method="post"  enctype="multipart/form-data">
      ...
      <tr>
        <td class="boderInner1"><table width="960" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td width="487"><span class="pageTitle">OFP Brochure Manager </span><span class="pageTitle1">[{if $pageview eq 'add'}Add{else}Edit{/if} Brochure]</span></td>
                    ...
                    <tbody>
                      <tr>
                        <td class="button" id="toolbar-apply"><a href="javascript:submitForm();" class="toolbar"> <img  value="Add" src="{$GENERAL.ADMIN_IMG_URL}/toolbar/icon-32-save.png" style="border:0px;"  /> <br />
                          Save</a> </td>
                        <td class="button" id="toolbar-cancel"><a href="javascript:location.href='{$GENERAL.BASE_URL_ADMIN}/ofpbrouchermanagement.php'" class="toolbar"><img src="{$GENERAL.ADMIN_IMG_URL}/toolbar/icon-32-cancel.png" border="0" alt="" /> <br />Cancel</a></td>
                      </tr>
                    </tbody>
                  </table>
                </div></td>
        ...
        <td class="boderInner2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td width="617" valign="top" class="boderInner2"><table width="98%" border="0" cellspacing="1" cellpadding="1" class="normalTxt">
                  <tr height="25" >
                    <td align="left" colspan="2" class="tipbox"><input type="hidden" name="ofpbid" value="{$data.ofpbid|escape}" />                    </td>
                  </tr>
                  <tr class="row2">
				  ...
				  <tr class="row2">
                        ...
                        <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="55%"><input type="file" onkeypress="return false;" name="filepath" size="25"  /><span class="required">&nbsp;*</span><br />(Image format pdf,msword,gif, jpeg, png.)
						{if $data.old_image ne ''}
							<a href="{$GENERAL.FRONT_UPLOAD_URL}/ofp-brochures/{$data.old_image}" target="_blank" class="link">view file</a>
                          ...
                          <div style="overflow: hidden; display: block; visibility: visible;  height: 1%;" class="normalTxt">
                            <div style="padding: 5px;" id="help1">
                              <ul>
                                ...
                                <li>To go back to Existing OFP Brochure Manager , click Cancel button</li>
  ...
  <!--- content area  --->
  {else}
  <form action="{$GENERAL.BASE_URL_ADMIN}/ofpbrouchermanagement.php" method="post">
    <table width="962" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td class="boderInner1"><table width="960" border="0" cellspacing="0" cellpadding="0">
            <tr>
            ...
            <tr>
              <td width="10" height="48" align="center">&nbsp;</td>
              <td width="56" valign="top"><img src="{$GENERAL.ADMIN_IMG_URL}/news2.png" alt="" width="48" height="48" /></td>
              <td width="445"><span class="pageTitle">OFP Brochure Manager </span><span class="pageTitle1">[Existing Brochure list]</span></td>
              <td width="439" align="right" valign="top"><div class="toolbar" id="toolbar">
                  <table class="toolbar">
                    <tr>
                      <td class="button" id="toolbar-apply" ><a style="toolbar" href='{$GENERAL.BASE_URL_ADMIN}/ofpbrouchermanagement.php?action=add&subcatofpbid={$subcatofpbid|escape}&catofpbid={$catofpbid|escape}'><img  border="0" type="image" src="{$GENERAL.ADMIN_IMG_URL}/toolbar/icon-32-new.png" /><br/> Add </a> </td>
                    </tr>
                  </table>
                </div></td>
              <td width="10" valign="top">&nbsp;</td>
      ...
      <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
         ...
         <table width="100%" border="0"  class="grid">
                      <tr  height="20">
                        <td align="left" style="padding-left:10px;" ><a href="javascript:sortRecords('filename',true)" class="th" >File Name </a></td>
                      ...
                      <tr class="row2"  style="height:25px;" >
                        ...
                        <td align="center"><img  style="border:0; cursor:pointer" border="0" type="image" src="{$GENERAL.ADMIN_IMG_URL}/toolbar/edit_s.png"  onclick="javascript:location.href='{$GENERAL.BASE_URL_ADMIN}/ofpbrouchermanagement.php?action=edit&ofpbid={$entry.ofpbid|escape}'"  class="btnText"  /> </td>
                        <td align="center"><img  style="border:0; cursor:pointer" type="image" src="{$GENERAL.ADMIN_IMG_URL}/toolbar/delete_s.png"  onclick="javascript:deleteconfirmation('{$entry.ofpbid|escape}');"  class="btnText"  /> </td>
                      </tr>
                      {foreachelse}
                      <tr>
