...
<script type="text/javascript">
	...
	function deleteconfirmation(podcastid)
	{
		if(confirm("Are you sure you want to delete this Podcost?"))
		{
			window.location.href='oeppodcastmanagement.php?action=del&podcastid='	+ podcastid;
		}	
	}
...
<table width="991" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <!--- content area form --->
  <form action="{$GENERAL.BASE_URL_ADMIN}/oeppodcastmanagement.php?action=submit&mode={$pageview}{if $pageview eq 'edit'}&podcastid={$data.podcastid}{/if}" method="post"enctype="multipart/form-data">
      ...
      <tr>
        <td class="boderInner1"><table width="960" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td width="631"><span class="pageTitle"><span class="tableHeader"> Podcast</span></span><span class="pageTitle1">[{if $pageview eq 'add'}Add{else}Edit{/if} Podcast]</span></td>
                  ...
                  <table class="toolbar">
                    <tbody>
                      <tr>
                        ...
                        <td class="button" id="toolbar-cancel"><a href="javascript:location.href='{$GENERAL.BASE_URL_ADMIN}/oeppodcastmanagement.php'" class="toolbar"><img src="{$GENERAL.ADMIN_IMG_URL}/toolbar/restore_f2.png" border="0" alt="" /> <br />Back</a></td>
                      </tr>
                    </tbody>
                  </table>
                </div></td>
        ...
        <td class="boderInner2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td width="617" valign="top" class="boderInner2"><table width="98%" border="0" cellspacing="1" cellpadding="1" class="normalTxt">
                  <tr height="25" >
                    <td align="left" colspan="2" class="tipbox"><input type="hidden" name="podcastid" value="{$data.podcastid|escape}" />                    </td>
                  </tr>
                  <tr class="row2">
                   ...
                   <!-- <tr class="row2" height="25">
                    ...
                    <td align="left"><select name="oepid" class="select_class" >
				  ...
				  <tr class="row2" height="25">
                    ...
                    <td align="left"><input type="file" onkeypress="return false;" name="pvideo" size="25"  /><span class="required">&nbsp;*</span> (Max. 50 MB, .flv only)
					{if $pageview eq 'edit'}
					<br />
                    <a href="{$GENERAL.FRONT_UPLOAD_URL}/podcasts/{$data.pvideo}" target="_blank" class="link">watch video</a>
					{/if}
					</td>					                   
                  </tr>
				  <tr class="row2" height="25">
                    <td align="right" width="19%" valign="top">Upload Thumbnail:&nbsp;</td>
                    <td align="left"><input type="file" onkeypress="return false;" name="pimage" size="25"  /><span class="required">&nbsp;*</span> (100px x 100px - Max. 2 MB, .jpg .png .gif)
					{if $pageview eq 'edit'}
					<br />
                    <a href="{$GENERAL.FRONT_UPLOAD_URL}/podcasts/{$data.pimage}" target="_blank" class="link">watch thumbnail</a>
					{/if}
					</td>					                   
                  </tr>
				  <tr class="row2" height="25">
                    <td align="right" width="19%">Enabled :&nbsp;</td>
                    <td align="left"><select class="select_class" name="enabled"><option value="Y" {if $data.enabled eq 'Y'} selected="selected"{/if}>Yes</option><option value="N" {if $data.enabled eq 'N'} selected="selected"{/if}>No</option></select>
                          ...
                          <div style="overflow: hidden; display: block; visibility: visible;  height: 1%;" class="normalTxt">
                            <div style="padding: 5px;" id="help1">
                              <ul>
                                ...
                                <li>To go back to Existing podcast, click Cancel button</li>
      ...
      <tr>
        <td class="boderInner1"><table width="960" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td width="10" height="48" align="center">&nbsp;</td>
              <td width="56" valign="top"><img src="{$GENERAL.ADMIN_IMG_URL}/podcast.gif" alt="" width="48" height="48" /></td>
              <td width="529"><span class="pageTitle"> Podcast Manager </span><span class="pageTitle1">[Existing  Podcasts]</span></td>
              <td width="355" align="right" valign="top"><div class="toolbar" id="toolbar">
                  <table class="toolbar">
                    <tr>
					  ...
					  <!-- <td class="button" id="toolbar-apply" ><a style="toolbar" href='{$GENERAL.BASE_URL_ADMIN}/oeppodcastmanagement.php?podcastid=4'><img  border="0" type="image" src="{$GENERAL.ADMIN_IMG_URL}/toolbar/icon-32-edit.png" /><br/>Home Page </a> </td>-->
                    </tr>
                  </table>
                </div></td>
              <td width="10" valign="top">&nbsp;</td>
      ...
      <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
         ...
         <table width="100%" border="0"  class="grid">
                      <tr  height="20">
                        <td align="center" ><a href="javascript:sortRecords('title',true)" class="th" >Podcast Title</a></td>
                       <!-- <td align="center" class="th"> Programmes</td>-->
                      ...
                      <tr class="row2"  style="height:25px;" >
                        ...
                        <td align="center"><img  style="border:0; cursor:pointer" border="0" type="image" src="{$GENERAL.ADMIN_IMG_URL}/toolbar/edit_s.png"  onclick="javascript:location.href='{$GENERAL.BASE_URL_ADMIN}/oeppodcastmanagement.php?action=edit&podcastid={$entry.podcastid|escape}'"  class="btnText"  /> </td>
                        <td align="center"><img  style="border:0; cursor:pointer" type="image" src="{$GENERAL.ADMIN_IMG_URL}/toolbar/delete_s.png"  onclick="javascript:deleteconfirmation('{$entry.podcastid|escape}');"  class="btnText"  /> </td>
                         </tr>
                      {/foreach}
                      <tr>
                      ...
                      <div class="panel"> <a href="Javascript:TogglePanel('help5');">
                        ...
                        <div style="overflow: hidden; display: block; visibility: visible;  height: 1%;" class="normalTxt">
                          <div style="padding: 5px;" id="help5">
                            <ul>
                              <li>To Add a record, click on the 'Add' button</li>
