              ...
              <tr>
                ...
                <td width="260">
			      <table width="100%" border="0" cellspacing="0" cellpadding="0">
					 <form name="frm_admin_login" method="post" id="frm_admin_login" action="{$GENERAL.BASE_URL_ADMIN}/index.php?action=submit">
					 ...
					 <tr>
					  ...
					  <tr>
						...
						<td class="normalTxt"><input name="password" type="password" class="input1" value="{$data.password}" maxlength="30" ></td>
					  </tr>
					  <tr>
						<td class="normalTxt">&nbsp;</td>
						<td height="35" class="normalTxt"><input type="image" src="{$GENERAL.ADMIN_IMG_URL}/log_btn.jpg" value="Login" class="btnText"></td>
					  </tr>
					  <tr>
						<td class="normalTxt">&nbsp;</td>
						<td class="normalTxt"><a class="th" href="{$GENERAL.BASE_URL_ADMIN}/forgotpassword.php">Forgot Password</a></td>
					  </tr>
					   </form>
					</table>
