...
-->
<script language="javascript" src='{$GENERAL.BASE_URL_ROOT}/js/jquery.js'></script>
<script language="javascript" src='{$GENERAL.BASE_URL_ROOT}/js/jscripts.js'></script>
<script src="{$GENERAL.BASE_URL_ROOT}/js/CalendarPopup.js"></script>
...
<table width="991" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <!--- content area form --->
  <form action="{$GENERAL.BASE_URL_ADMIN}/ofpmanagement.php?action=submit&mode={$pageview}{if $pageview eq 'edit'}&id={$data.ofpid}{/if}" method="post"  enctype="multipart/form-data" name="frmadd">
      ...
      <tr>
        <td class="boderInner1"><table width="960" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td width="56" valign="top"><img src="{$GENERAL.ADMIN_IMG_URL}/ofp.gif" alt="" width="48" height="48" /></td>
              <td width="445"><span class="pageTitle"><span class="tableHeader">OFP Manager</span></span><span class="pageTitle1">&nbsp;[{if $pageview eq 'add'}Add{else}Edit{/if} programme]</span></td>
                    ...
                    <tbody>
                      <tr>
                        <td class="button" id="toolbar-apply"><a href="javascript:submitForm();" class="toolbar"> <img  value="Add" src="{$GENERAL.ADMIN_IMG_URL}/toolbar/icon-32-save.png" style="border:0px;"  /> <br />
                          Save</a> </td>
                        <td class="button" id="toolbar-cancel"><a href="javascript:location.href='{$GENERAL.BASE_URL_ADMIN}/ofpmanagement.php'" class="toolbar"><img src="{$GENERAL.ADMIN_IMG_URL}/toolbar/icon-32-cancel.png" border="0" alt="" /> <br />Cancel</a></td>
                      </tr>
                    </tbody>
                  </table>
                </div></td>
        ...
        <td class="boderInner2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td width="617" valign="top" class="boderInner2">
                  ...
                  <tr height="25" >
                    <td align="left" colspan="2" class="tipbox"><input type="hidden" name="id" value="{$smarty.get.id}" />                    </td>
                  </tr>
                
				  <tr class="row2">
                    <td width="24%" align="right" valign="top">Client Organization Name :&nbsp;</td>
                    <td width="76%" align="left"><input type="text" name="clientorgname" class="input" value="{$data.clientorgname|escape}"  maxlength="100"/>
                      <span class="required">&nbsp;*</span></td>
                  </tr> 
				  <tr class="row2">
                    <td width="24%" align="right" valign="top">Org Address :&nbsp;</td>
                    <td width="76%" align="left"><input type="text" name="orgaddress" class="input" value="{$data.orgaddress|escape}"  maxlength="100"/>
                      <span class="required">&nbsp;*</span></td>
                  </tr> 
 				<tr class="row2">
                    <td width="40%" align="right" valign="top">Client Contact Person :&nbsp;</td>
                    <td width="76%" align="left"><input type="text" name="clientcp" class="input" value="{$data.clientcp|escape}"  maxlength="50"/>
                      <span class="required">&nbsp;*</span></td>
                  </tr> 
				  <tr class="row2">
                    <td width="24%" align="right" valign="top">Programme Name :&nbsp;</td>
                    <td width="76%" align="left"><input type="text" name="name" class="input" value="{$data.name|escape}"  maxlength="255"/>
                      <span class="required">&nbsp;*</span></td>
                  </tr> 
                  ...
                  <tr class="row2">
                        ...
                        <td align="left"><input type="text" name="startdate" class="input" value="{$data.startdate|escape}" readonly="" id="stamp1">
					  ...
					  <tr class="row2">
						...
						<td align="left"><input type="text" name="enddate" class="input" value="{$data.enddate|escape}" readonly="" id="stamp2">
				   ...
				   <tr class="row2">
                    ...
                    <td width="81%" align="left">
						...
						selectDropdown('programmedirector', '{$data.programmedirector}');
						</script>
                      </td>
                  </tr>
				  <tr class="row2">
                    <td width="19%" align="right" valign="top">Module Name :&nbsp;</td>
                    <td width="81%" align="left"><input type="text" name="modulename" class="input" value="{$data.modulename|escape}"  maxlength="150"/>
                      <span class="required">&nbsp;*</span></td>
                  </tr>
				    <tr class="row2">
                    ...
                    <td width="81%" align="left">
						<select name="moduledirector" class="select_class" >
							{foreach from =$faculty item="fac"}
								{if $fac.fid eq $data.moduledirector}
				  ...
				  <tr class="row2">
                    ...
                    <td width="81%" align="left"><input type="text" name="totalparticipants" class="input" value="{$data.totalparticipants|escape}"  maxlength="5"/>
                      <span class="required">&nbsp;*</span></td>
                  </tr>
				 <tr class="row2">
                    ...
                    <td width="81%" align="left">
						...
						<span class="required">&nbsp;</span>
                        <script language="javascript" type="text/javascript">
						selectDropdown('programmelevel', '{$data.programmelevel}');
						</script>
                      </td>
                  </tr>
				   <tr class="row2">
                    ...
                    <td width="81%" align="left">
						...
						<span class="required">&nbsp;*</span>
                        <script language="javascript" type="text/javascript">
						selectDropdown('programmesite', '{$data.programmesite}');
						</script>
                      </td>
                  </tr> 
				   <tr class="row2">
                    ...
                    <td width="81%" align="left">
						...
						<span class="required">&nbsp;*</span>
                        <script language="javascript" type="text/javascript">
						selectDropdown('programmeresidence', '{$data.programmeresidence}');
						</script>
                      </td>
                  </tr>   
				 <tr class="row2">
                    ...
                    <td width="81%" align="left">
						<textarea maxlength='300' name="preprogrammeact" id="preprogrammeact" class="txtArea" onkeyup="return ismaxlength(this)">{$data.preprogrammeact|escape}</textarea>
						<span class="required">&nbsp;</span></td>
                  </tr>		
				   ...
				   <tr class="row2">
                    ...
                    <td width="81%" align="left">
						<textarea maxlength='300' name="postprogrammeact" id="postprogrammeact" class="txtArea" onkeyup="return ismaxlength(this)">{$data.postprogrammeact|escape}</textarea>
						<span class="required">&nbsp;</span></td>
                  </tr>						
				  ...
				  <!-- <tr class="row2">
                    ...
                    <td width="81%" align="left"><input type="text" name="fee" class="input" value="{$data.fee|escape}"  maxlength="6"/><span class="required">&nbsp;*</span>
                     </td>
					 </tr>-->
                   <tr class="row2">
                    ...
                    <td width="81%" align="left">
							<select name="enabled" id="enabled" class="select_class">
								 ...
								 <option value="No" {if $data.enabled eq "No"}selected="selected"{/if}>No</option>
							</select>
                     </td>
                  </tr>
  ...
  <!--- content area  --->
  {else}
  <form action="{$GENERAL.BASE_URL_ADMIN}/ofpmanagement.php" method="post">
        ...
        <td class="boderInner1"><table width="960" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td width="439" align="right" valign="top"><div class="toolbar" id="toolbar">
                  <table class="toolbar">
                    <tr>
                      <td class="button" id="toolbar-apply" ><a style="toolbar" href='{$GENERAL.BASE_URL_ADMIN}/ofpmanagement.php?action=add'><img  border="0" type="image" src="{$GENERAL.ADMIN_IMG_URL}/toolbar/icon-32-new.png" /><br/> 
                        Add </a> </td>
						
						
		{if $status ne ""}
								<td class="button" id="toolbar-apply" ><a href="{$GENERAL.BASE_URL_ADMIN}/ofpmanagement.php" style="toolbar">
									<img src="{$GENERAL.ADMIN_IMG_URL}/toolbar/icon-32-default.png" border="0" title="view open programmes" /><br/> Open Programmes </a> 
								</td>
							{else}	
								<td class="button" id="toolbar-apply" ><a href="{$GENERAL.BASE_URL_ADMIN}/ofpmanagement.php?status=C" style="toolbar">
									<img src="{$GENERAL.ADMIN_IMG_URL}/toolbar/icon-32-cancel.png" border="0" title="view completed programmes" /><br/> Completed Programmes </a> 								</td>
                    		{/if}				
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-bottom:7px;">
				<tr>
					...
					<td  width="164" style="padding-left:3px; padding-top:5px;"><input type="text" name="search_by_cname" class="input" value="{$formvars.search_by_cname}"  maxlength="100"/></td>
					<td>&nbsp;</td>
				</tr>
				<tr>	
         ...
         <table width="100%" border="0"  class="grid" style="padding-top:7px;">
                      ...
                      <tr class="row2"  style="height:25px;" >
						...
						<td align="center">{$entry.clientorgname}</td>
                        <td align="center">{$entry.startdate}</td>
						<td align="center">{$entry.enabled}</td>
						<td align="center"><img  style="border:0; cursor:pointer" border="0" type="image" src="{$GENERAL.ADMIN_IMG_URL}/toolbar/view_S.png"  onclick="javascript:location.href='javascript:viewParticipant({$entry.ofpid|escape} , \'{$smarty.get.status}\')'"  class="btnText"  /> </td>
						<!--<td align="center"><a href="javascript:viewParticipant({$entry.ofpid|escape})" style="color:#048DB1;">View</a></td>-->
						<!--<td align="center">{$entry.enabled}</td>-->
						<td align="center"><img  style="border:0; cursor:pointer" border="0" type="image" src="{$GENERAL.ADMIN_IMG_URL}/toolbar/edit_s.png"  onclick="javascript:location.href='{$GENERAL.BASE_URL_ADMIN}/ofpmanagement.php?action=edit&id={$entry.ofpid|escape}'"  class="btnText"  /> </td>
                        <td align="center"><img  style="border:0; cursor:pointer" type="image" src="{$GENERAL.ADMIN_IMG_URL}/toolbar/delete_s.png"  onclick="javascript:deleteconfirmation('{$entry.ofpid|escape}');"  class="btnText"  /> </td>
                       </tr>
                      {/foreach}
