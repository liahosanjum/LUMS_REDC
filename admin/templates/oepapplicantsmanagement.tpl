...
<script type="text/javascript">
	...
	function deleteconfirmation(id)
	{
		...
		{
			window.location.href='oepapplicantsmanagement.php?action=del&id='+ id+"&iscompleted={/literal}{$smarty.get.iscompleted}{if $smarty.get.start gt 0}&sc={$smarty.get.sc}&sd={$smarty.get.sd}&start={$smarty.get.start}{/if}&status={$smarty.get.status}{literal}";
		}	
	}
...
<table width="991" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <!--- content area form --->
  <form action="{$GENERAL.BASE_URL_ADMIN}/oepapplicantsmanagement.php?action=submit&mode={$pageview}{if $pageview eq 'edit'}&id={$smarty.get.id}{/if}&iscompleted={$smarty.get.iscompleted}{if $smarty.get.start gt 0}&sc={$smarty.get.sc}&sd={$smarty.get.sd}&start={$smarty.get.start}{/if}&status={$smarty.get.status}" method="post"  enctype="multipart/form-data" name="frmadd">
                    ...
                    <tbody>
                      <tr>
						...
						<td class="button" id="toolbar-apply"><a href="javascript:submitForm();" class="toolbar"> <img  value="Add" src="{$GENERAL.ADMIN_IMG_URL}/toolbar/icon-32-save.png" style="border:0px;"  /> <br />
                          Save</a> </td>
						  {/if}
                        <td class="button" id="toolbar-cancel"><a href="javascript:location.href='{$GENERAL.BASE_URL_ADMIN}/oepapplicantsmanagement.php?pid={$pid}&iscompleted={$smarty.get.iscompleted}{if $smarty.get.start gt 0}&sc={$smarty.get.sc}&sd={$smarty.get.sd}&start={$smarty.get.start}{/if}&status={$smarty.get.status}'" class="toolbar"><img src="{$GENERAL.ADMIN_IMG_URL}/toolbar/icon-32-cancel.png" border="0" alt="" /> <br />Cancel</a></td>
                      </tr>
                    </tbody>
                  </table>
                </div></td>
        ...
        <td class="boderInner2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td width="617" valign="top" class="boderInner2">
						...
						<select name="uid" id="uid" class="select_class" onchange="return setName(this);">
							...
							{foreach from=$users item='u'}
								{if $u.uid eq $data.uid and $u.firstname ne ''}
									<option value="{$u.uid}" selected="selected">{$u.firstname}.{$u.lastname}.[{$u.email}]</option>
									{elseif $u.firstname ne ''}
									<option value="{$u.uid}">{$u.firstname}.{$u.lastname}.[{$u.email}]</option>
								{/if}
				   ...
				   <tr class="row2">
                    ...
                    <td width="81%" align="left">
						<select name="learnabout" class="select_class">
							...
							<option value="Brochure" {if $data.learnabout eq 'Brochure'} selected="selected" {/if}>Brochure</option>
							<option value="Referred by HR department" {if $data.learnabout eq 'Referred by HR department'} selected="selected" {/if}>Referred by HR department</option>
						
						<option value="Press Advertisement" {if $data.learnabout eq 'Press Advertisement'} selected="selected" {/if}>Press Advertisement</option>
                        <option value="Web Advertisement" {if $data.learnabout eq 'Web Advertisement'} selected="selected" {/if}>Web Advertisement</option>
                ...
                {else}
                	<input type="hidden" name="oepprogrammes" value="{$data.oepid}" />
					<input type="hidden" name="status" value="{$data.applicationstatus}" />
                {/if}			  
				{*
				   <tr class="row2">
            ...
            <tr>
              ...
              <td width="439" align="right" valign="top"><div class="toolbar" id="toolbar">
                  <table class="toolbar">
                    <tbody>
                      <tr>
                      	<td class="button" id="toolbar-cancel"><a target="_blank" href="{$GENERAL.BASE_URL_ADMIN}/oepapplicant.php?oepaid={$data.oepaid}" class="toolbar"><img src="{$GENERAL.ADMIN_IMG_URL}/toolbar/Print-icon.png" border="0" alt=""  /> <br />Print Application</a></td>
						...
						<td class="button" id="toolbar-apply"><a href="{$GENERAL.BASE_URL_ADMIN}/oepapplicantsmanagement.php?status=A&oepaid={$data.oepaid}&action=submit&mode=change&pid={$pid}&iscompleted={$smarty.get.iscompleted}" class="toolbar"> <img  value="Add" src="{$GENERAL.ADMIN_IMG_URL}/toolbar/icon-32-apply.png" style="border:0px;"  /> <br />
                         ...
                         {if $data.applicationstatus ne ''}
                         	<td class="button" id="toolbar-apply"><a href="{$GENERAL.BASE_URL_ADMIN}/oepapplicantsmanagement.php?status=&oepaid={$data.oepaid}&action=submit&mode=change&pid={$pid}&iscompleted={$smarty.get.iscompleted}" class="toolbar"> <img  value="Add" src="{$GENERAL.ADMIN_IMG_URL}/toolbar/icon-32-default.png" style="border:0px;"  /> <br />
                         ...
                         <!-- {if $data.applicationstatus eq 'R'}
                          ...
                          Reject Application</a> </td> 
						  {/if}-->
                        <td class="button" id="toolbar-cancel"><a href="javascript:location.href='{$GENERAL.BASE_URL_ADMIN}/oepapplicantsmanagement.php?status={$data.applicationstatus}&pid={$pid}&iscompleted={$smarty.get.iscompleted}{if $smarty.get.start gt 0}&sc={$smarty.get.sc}&sd={$smarty.get.sd}&start={$smarty.get.start}{/if}'" class="toolbar"><img src="{$GENERAL.ADMIN_IMG_URL}/toolbar/restore_f2.png" border="0" alt="" /> <br />Back</a></td>
                      </tr>
                    </tbody>
                  </table>
                </div></td>
                          ...
                          <div style="overflow: hidden; display: block; visibility: visible;  height: 1%;" class="normalTxt">
                            <div style="padding: 5px;" id="help1">
                              <ul>
								...
								{if $data.applicationstatus ne 'A' and $data.applicationstatus ne 'R'}
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
         ...
         <table width="100%" border="0"  class="grid" style="padding-top:7px;">
                      ...
                      <tr class="row2"  style="height:25px;" >
						...
						<td align="center"><img  style="border:0; cursor:pointer" border="0" type="image" src="{$GENERAL.ADMIN_IMG_URL}/toolbar/view_S.png"  onclick="javascript:location.href='{$GENERAL.BASE_URL_ADMIN}/oepapplicantsmanagement.php?action=detail&id={$entry.oepaid|escape}&pid={$pid}&iscompleted={$smarty.get.iscompleted}{if $smarty.get.start gt 0}&sc={$smarty.get.sc}&sd={$smarty.get.sd}&start={$smarty.get.start}{/if}&status={$smarty.get.status}'"  class="btnText"  /> </td>
                        
                        <td align="center"><img  style="border:0; cursor:pointer" border="0" type="image" src="{$GENERAL.ADMIN_IMG_URL}/toolbar/edit_s.png"  onclick="javascript:location.href='{$GENERAL.BASE_URL_ADMIN}/oepapplicantsmanagement.php?action=edit&id={$entry.oepaid|escape}&pid={$pid}&iscompleted={$smarty.get.iscompleted}{if $smarty.get.start gt 0}&sc={$smarty.get.sc}&sd={$smarty.get.sd}&start={$smarty.get.start}{/if}&status={$smarty.get.status}'"  class="btnText"  /> </td>
