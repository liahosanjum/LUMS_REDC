...
<script type="text/javascript">
	...
	function deleteconfirmation(id)
	{
		...
		{
			window.location.href='usermanagement.php?action=del&id='	+ id;
		}	
	}
...
<table width="991" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <!--- content area form --->
  <form action="{$GENERAL.BASE_URL_ADMIN}/usermanagement.php?action=submit&mode={$pageview}&id={$smarty.get.id}" method="post"  enctype="multipart/form-data">
      ...
      <tr>
        <td class="boderInner1"><table width="960" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td width="445"><span class="pageTitle"><span class="tableHeader">User Manager </span><span class="pageTitle1">[{if $pageview eq 'add'}Add{else}Edit{/if} User]</span></td>
                    ...
                    <tbody>
                      <tr>
                        <td class="button" id="toolbar-apply"><a href="javascript:submitForm();" class="toolbar"> <img  value="Add" src="{$GENERAL.ADMIN_IMG_URL}/toolbar/icon-32-save.png" style="border:0px;"  /> <br />
                          Save</a> </td>
                        <td class="button" id="toolbar-cancel"><a href="javascript:location.href='{$GENERAL.BASE_URL_ADMIN}/usermanagement.php'" class="toolbar"><img src="{$GENERAL.ADMIN_IMG_URL}/toolbar/icon-32-cancel.png" border="0" alt="" /> <br />Cancel</a></td>
                      </tr>
                    </tbody>
                  </table>
                </div></td>
        ...
        <td class="boderInner2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td width="647" valign="top" class="boderInner2"><table width="98%" border="0" cellspacing="1" cellpadding="1" class="normalTxt">
                  <tr height="25" >
                    <td align="left" colspan="2" ><input type="hidden" name="id" value="{$smarty.get.id}" /></td>
                  </tr>
					 <tr><td height="5"></td></tr>
					  <!--<tr>
					   ...
					   <tr>
					     ...
					     <td align="left"><input class="input" name="firstname" type="text" id="firstname" value="{$data.firstname|escape}" size="30" maxlength="20" />
				         <span class="required">*</span></td>
				      </tr>					  
					 <tr><td height="5"></td></tr>
					  <tr>
					     <td align="right">Last Name:&nbsp; </td>
					     <td align="left"><input class="input" name="lastname" type="text" id="lastname" value="{$data.lastname|escape}" size="30" maxlength="20" />
				         <span class="required">*</span></td>
				      </tr>	
					   <tr><td height="5"></td></tr>
                  ...
                  <tr><td colspan="2" height="5"></td></tr>
					  <tr>
						 ...
						 {if $pageview eq "edit"}
						 	...
						 	{if $data.type eq 'oep'} <b>OEP Applicant</b>
							{elseif $data.type eq 'ofp'} <b>OFP Participant</b>
							{/if}
							
						 {elseif $pageview eq "add"}
						 <select name="type" id="type" style="width:175px; color:#666666;" class="select_class_large">
						 	<option value="" {if $data.type eq ''} selected="selected" {/if}>select user type</option>
							<option value="oep" {if $data.type eq 'oep'} selected="selected" {/if}>OEP Applicant</option>
							<option value="ofp" {if $data.type eq 'ofp'} selected="selected" {/if}>OFP Participant</option>
						 </select>
						 {/if}
						  <span class="required">*</span></td>
				      </tr>					  
				  ...
				  <tr><td colspan="2" height="5"></td></tr>
					  <tr>
					     ...
					     <td align="left">
						 <select name="isactive" id="isactive" style="width:175px; color:#666666;" class="select_class_large">
						 	<option value="Y" {if $data.isactive eq 'Y'} selected="selected" {/if}>Yes</option>
							<option value="N" {if $data.isactive eq 'N'} selected="selected" {/if}>No</option>
						 </select>
						 </td>
				      </tr>					  
                          ...
                          <div style="overflow: hidden; display: block; visibility: visible;  height: 1%;" class="normalTxt">
                            <div style="padding: 5px;" id="help1">
                              <ul>
                                ...
                                <li>To go back to Existing Users, click Cancel button</li>
  ...
  <!--- content area  --->
  {else}
  <form action="{$GENERAL.BASE_URL_ADMIN}/usermanagement.php" method="post">
    <table width="962" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td class="boderInner1"><table width="960" border="0" cellspacing="0" cellpadding="0">
            <tr>
            ...
            <tr>
              <td width="10" height="48" align="center">&nbsp;</td>
              <td width="56" valign="top"><img src="{$GENERAL.ADMIN_IMG_URL}/header/icon-48-article.png" alt="" width="48" height="48" /></td>
              <td width="445"><span class="pageTitle">User Manager </span><span class="pageTitle1">[Existing User]</span></td>
              <td width="439" align="right" valign="top"><div class="toolbar" id="toolbar">
                  <table class="toolbar">
                    <tr>
                      <td class="button" id="toolbar-apply" ><a style="toolbar" href='{$GENERAL.BASE_URL_ADMIN}/usermanagement.php?action=add&subcatid={$subcatid|escape}&catid={$catid|escape}'><img  border="0" type="image" src="{$GENERAL.ADMIN_IMG_URL}/toolbar/icon-32-new.png" /><br/> Add </a> </td>
                    </tr>
                  </table>
                </div></td>
              <td width="10" valign="top">&nbsp;</td>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
         ...
         <table width="100%" border="0"  class="grid">
                      ...
                      <tr class="row2"  style="height:25px;" >
                        ...
                        <td align="center"><img  style="border:0; cursor:pointer" type="image" src="{$GENERAL.ADMIN_IMG_URL}/toolbar/edit_s.png"  onclick="javascript:location.href='{$GENERAL.BASE_URL_ADMIN}/usermanagement.php?action=edit&id={$entry.uid|escape}'"  class="btnText"  /> </td>
                        <td align="center"><img  style="border:0; cursor:pointer" type="image" src="{$GENERAL.ADMIN_IMG_URL}/toolbar/delete_s.png"  onclick="javascript:deleteconfirmation('{$entry.uid|escape}');"  class="btnText"  /> </td>
                      </tr>
                      {foreachelse}
                      <tr>
                        <td colspan="5">No existing user found</td>
                      </tr>
                      {/foreach}
                      <tr>
