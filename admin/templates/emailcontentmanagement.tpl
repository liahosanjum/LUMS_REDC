...
<script type="text/javascript">
	...
	function deleteconfirmation(ecid)
	{
		...
		{
			window.location.href='emailcontentmanagement.php?action=del&id='	+ ecid;
		}	
	}
...
<table width="991" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td class="boder"> {* Smarty *}
      ...
      <!--- content area form --->
      <form action="{$GENERAL.BASE_URL_ADMIN}/emailcontentmanagement.php?action=submit&mode={$pageview}{if $pageview eq 'edit'}{/if}" $pageview method="post" enctype="multipart/form-data" >
          ...
          <tr>
            <td class="boderInner1"><table width="960" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td width="445"><span class="pageTitle"><span class="tableHeader">Email Content</span> Manager </span><span class="pageTitle1">[{if $pageview eq 'add'}Add{else}Edit{/if} Email]</span></td>
                  <td width="439" align="right" valign="top"><div class="toolbar" id="toolbar">
                      <table class="toolbar">
                        <tbody>
                          <tr>
                            <td class="button" id="toolbar-apply"><a href="javascript: void(0);" onclick="javascript: submitForm();" class="toolbar"><img src="{$GENERAL.ADMIN_IMG_URL}/toolbar/icon-32-apply.png" border="0" alt="" /> <br />
							  Apply</a></td>
                            <td class="button" id="toolbar-cancel"><a href="javascript:location.href='{$GENERAL.BASE_URL_ADMIN}/emailcontentmanagement.php'" class="toolbar"><img src="{$GENERAL.ADMIN_IMG_URL}/toolbar/icon-32-cancel.png" border="0" alt="" /> <br />
                              Cancel</a></td>
                          </tr>
                        </tbody>
                      </table>
                ...
                <td width="10" align="center">&nbsp;</td>
				  ...
				  <table width="98%" border="0" cellspacing="1" cellpadding="1"  class="grid">
					  ...
					  <tr height="25" >
						...
						<input type="hidden" name="ecid" value="{$data.ecid|escape}" />
						</td>
                      </tr>
                      <tr class="row1">
                        <td align="right" valign="top">{if $emailname eq 'Contact Us'}To{else}From{/if} Name:&nbsp;</td>
                        <td width="84%" align="left">
						<input type="text" name="fromname" class="input" value="{$data.fromname|escape}" maxlength="50" />
                          <span class="required">&nbsp;*</span></td>
                      </tr>
					  <tr class="row1">
                        <td align="right" valign="top">{if $emailname eq 'Contact Us'}To{else}From{/if} Email:&nbsp;</td>
                        <td width="84%" align="left">
					  ...
					  <tr class="row1">
					   ...
					   <tr >
                        <td align="left" colspan="2" class="boderInner2">
						<table width="100%" border="0"  class="grid">
                      <tr  height="20">
                        <td style="width:50%" align="center" class="th" >Name</td>
                        <td style="width:50%" align="center"  class="th" >Variables</td>
				      </tr>
						{foreach from=$emailvariable item="entry"}
                      <tr class="row2"  style="height:25px;" >
                        <td align="center">{$entry.name|escape}</td>
                        <td align="center"> {$entry.variable|escape} </td>
					  </tr>
                      {foreachelse}
                      <tr>
                        <td colspan="5">No existing variables found</td>
                      </tr>
                      {/foreach}
					  </table>
						</td>
      ...
      <!--- content area  --->
      {else}
      <form action="{$GENERAL.BASE_URL_ADMIN}/emailcontentmanagement.php" method="post">
        <table width="962" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td class="boderInner1"><table width="960" border="0" cellspacing="0" cellpadding="0">
                <tr>
                ...
                <tr>
                  <td width="10" height="48" align="center">&nbsp;</td>
                  <td width="56" valign="top"><img src="{$GENERAL.ADMIN_IMG_URL}/icon-48-massmail.png" alt="" width="48" height="48" /></td>
                  <td width="445"><span class="pageTitle">Email Content Manager </span><span class="pageTitle1">[Existing Emails]</span></td>
                  <td width="439" align="right" valign="top"><div class="toolbar" id="toolbar"> </div></td>
                  <td width="10" valign="top">&nbsp;</td>
                </tr>
                <tr>
                  <td height="5" colspan="5" align="center"></td>
            ...
            <td class="boderInner2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="10" colspan="5" align="center"><input type="hidden" name="sortcolumn" value="{$sortcolumn}" />
					...
					<input type="hidden" name="ecid" value="{$data.ecid|escape}" />
					<input type="hidden" name="emailvariable" value="{$data.emailvariable|escape}" />
                  </td>
                </tr>
                <td width="10" align="center">&nbsp;</td>
                  <td width="617" valign="top" class="boderInner2"><table width="100%" border="0"  class="grid">
                      ...
                      <tr class="row1">
                        <td height="4" colspan="6" align="center" class="borderBtmDashed"></td>
                      </tr>
                      ...
                      <tr class="row2"  style="height:25px;" >
                        ...
                        <td valign="top" align="center"><img  style="border:0; cursor:pointer" border="0" type="image" src="{$GENERAL.ADMIN_IMG_URL}/toolbar/edit_s.png"  onclick="javascript:location.href='{$GENERAL.BASE_URL_ADMIN}/emailcontentmanagement.php?action=edit&id={$entry.ecid|escape}'"  class="btnText"  /> </td>
                      </tr>
                      {foreachelse}
                      <tr>
                        <td colspan="5">No existing email found</td>
                      </tr>
                      {/foreach}
                    </table></td>
                  <td width="8">&nbsp;</td>
