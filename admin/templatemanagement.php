...
require_once($GENERAL['ADMIN_DIR_LIB'].'/templatemanagement.lib.php');
require_once($GENERAL['BASE_DIR_ROOT'].'/fckeditor/fckeditor.php');
// create Gallery Management object
$controller =& new templatemanagement;
...
switch($_action) {
    case 'add':
	 ...
	 case 'edit':
		...
		$controller->displayForm($controller->editEntry($_GET['ecid']));
	    break;
	case 'del':
        // deleting an entry
		$controller->pageview="del";
		$controller->deleteEntry($_GET['ecid']);
