...
require_once($GENERAL['ADMIN_DIR_LIB'].'/ofprequestsmanagement.lib.php');

// create Contactus Management object
$controller =& new ContactusManagement;

$_status = (isset($_REQUEST['status']) && $_REQUEST['status'] != "") ? $_REQUEST['status'] : '';
...
switch($_action) {
    case 'close':
     	// close a Contactus entry
			...
			$controller->displayGird($controller->getEntries($_start,$_POST, $_status));  
	    break;
