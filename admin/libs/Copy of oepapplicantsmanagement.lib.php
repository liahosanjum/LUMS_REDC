...
//		$_query = "select oepid , name from ".$this->table_name." where iscompleted = 'N' and isactive = 'Yes' and enddate > '".date("Y-m-d")."'";
		$_query = "select oepid , name from ".$this->table_name." where isactive = 'Yes' and (enddate > '".date("Y-m-d")."' or status = 'tba')";
...
//		$_query = "select oepid , name from ".$this->table_name." where iscompleted = 'N' and isactive = 'Yes' and enddate > '".date("Y-m-d")."'";
		...
		$_query = "select uid , firstname , lastname from ".$this->usertblname." where isactive = 'Y' and type = 'oep' ";
		return $this->select($_query);
	}
