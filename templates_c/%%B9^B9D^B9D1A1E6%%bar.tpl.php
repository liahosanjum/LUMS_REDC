<?php /* Smarty version 2.6.22, created on 2011-04-26 02:32:25
         compiled from bar.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'bar.tpl', 55, false),)), $this); ?>
<?php echo '
<style type="text/css">
...
/site_map.php?pagename=Site Map&pcid=<?php echo $_GET['pcid']; ?>
&url=<?php  echo URL; ?>">Site Index</a></li>
			...
			<div class="right_footer_links" id="contactForm">
				<ul>
					...
					<li><a href="playvideo.php?keepThis=true&amp;TB_iframe=true&amp;height=500&amp;width=450" alt="<?php echo $this->_tpl_vars['d']['title']; ?>
" class="thickbox">Podcasts</a></li>	
					<li><a href="#" class="contact">Contact Us</a></li>
					<li><a href="prog_finder.php?section_id=0&pcid=300" title="Direction To LUMS"  >Programme Calendar</a></li>
                    </ul>

                <a href="<?php  echo SITE_URL; ?>/faq.php?pagename=FAQs&section_id=0"><img src="<?php echo $this->_tpl_vars['GENERAL']['FRONT_IMG_URL']; ?>
