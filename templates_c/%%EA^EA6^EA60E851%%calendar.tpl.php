<?php /* Smarty version 2.6.22, created on 2011-04-26 03:18:35
         compiled from calendar.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'calendar.tpl', 205, false),array('modifier', 'date_format', 'calendar.tpl', 214, false),)), $this); ?>
...
" />
<title>Programme Calendar</title>
<meta name="keywords" content="<?php echo $this->_tpl_vars['pagedata']['keywords']; ?>
" />
...
/homeSectionPictures/<?php echo $this->_tpl_vars['simage']['0']['sec_image']; ?>
) no-repeat;"><h1>Programme Calendar</h1></div>
        	<!--<div class="main_heading" style="background:url(images/banr.gif) no-repeat;"><h1><?php echo $this->_tpl_vars['pagedata']['pagename']; ?>
</h1></div>-->
            <div class="programme_details" style="display:<?php if ($this->_tpl_vars['pagedata']['details'] == ""): ?>none<?php endif; ?>" >
		...
		<p>
			Please select the program from below list to apply online
			</p	>
...
">
 ...
 detail ">
                    ...
                    <?php if ($this->_tpl_vars['entry']['status'] != 'tba'): ?>
					<a class="list1" href="<?php echo $this->_tpl_vars['GENERAL']['BASE_URL_ROOT']; ?>
/apply.php?pid=<?php  echo encrypt($this->_tpl_vars['entry']['oepid']); ?>#apply">Apply</a><?php else: ?><span style="font-weight:bold">Apply</span>
                    <?php endif; ?>
                 </li>
				<?php endforeach; endif; unset($_from); ?>
        ...
        <div style="width:100%; clear:left; display:<?php if ($this->_tpl_vars['pagenum'] < 10): ?>none;<?php endif; ?>"><?php echo $this->_tpl_vars['paging']; ?>
</div>
    </div>
