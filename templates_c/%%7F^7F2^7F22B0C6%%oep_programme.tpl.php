<?php /* Smarty version 2.6.22, created on 2011-04-26 02:35:46
         compiled from oep_programme.tpl */ ?>
<?php 
		$id = 0;
...
<script language="javascript">
	var uid 	 = '<?php  echo $id; ?>';
	var oepid 	 = '';
	var callbackurl = '<?php echo SITE_URL; ?>/oep_programme.php?section_id=0&pcid='+<?php echo $_GET['pcid']; ?>
;
...
<div class="contentspane">
  <div  class="content">
    <div class="left_pane">
		...
		<div>
		<ul>
			<li><a href="#" class="<?php if ($_GET['pcid'] != ''): ?>selected<?php endif; ?>" onclick="javascript:showDiv('oep');" ><strong>Open Enrollment Programmes</strong></a></li>
		</ul>
		</div>
...
" ><?php echo $this->_tpl_vars['entry']['pagename']; ?>
       ...
       <div  ><a href="<?php echo SITE_URL; ?>/prog_finder.php" ><img style="padding-top:20px;" src="images/program_finder.gif" alt="Programme Finder"  border="0"/></a>  <?php echo $this->_tpl_vars['pageimage']['new_image']; ?>
</div>
